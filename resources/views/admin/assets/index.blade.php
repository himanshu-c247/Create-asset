                ...
                <tbody>
                    @foreach($assets as $key => $asset)
                        <tr data-entry-id="{{ $asset->id }}">
                            ...
                            <td class="text-center">
                                @can('asset_show')
                                    <a class="btn btn-sm btn-primary" href="{{ route('admin.assets.show', $asset->id) }}" data-toggle="tooltip" data-placement="top" title="View">
                                       <i class="fa fa-eye"></i>
                                    </a>
                                @endcan

                                @can('asset_edit')
                                    <a class="btn btn-sm btn-info" href="{{ route('admin.assets.edit', $asset->id) }}" data-toggle="tooltip" data-placement="top" title="Edit">
